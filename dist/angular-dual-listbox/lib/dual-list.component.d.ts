...
export declare class DualListComponent implements DoCheck, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DualListComponent, "dual-list", never, { "id": "id"; "key": "key"; "display": "display"; "height": "height"; "filter": "filter"; "format": "format"; "sort": "sort"; "compare": "compare"; "disabled": "disabled"; "source": "source"; "destination": "destination"; }, { "destinationChange": "destinationChange"; }, never, never>;
}
